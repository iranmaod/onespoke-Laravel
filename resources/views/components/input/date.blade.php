...
<div
    ...
    x-init="new Pikaday({ field: $refs.input, format: 'DD/MM/YYYY', onOpen() { this.setDate(moment($refs.input.value, 'DD/MM/YYYY').format('YYYY-MM-DD')) } })"
...
>
    ...
    <input
        ...
        x-ref="input"
        x-bind:value="value"
        class="rounded-none rounded-r-md block w-full pl-3 pr-10 py-2 text-base leading-6 border border-gray-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
    />
</div>
