...
<div class="card">
    ...
    <div class="card-block">
        ...
        <hr> @endif
        <form action="{{route('work.page.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <div class="col-sm-8 col-lg-10">
                    <textarea rows="5" required id="content" class="form-control no-resize editor" name="content" placeholder="Description ...">
                            </textarea>
                </div>
            </div>
