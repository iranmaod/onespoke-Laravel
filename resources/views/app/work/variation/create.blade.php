...
<div class="card">
    <div class="card-header">
        <h5>Create Variation Category</h5>
    </div>
    <div class="card-block">
        <form action="{{route('work.variation.store')}}" method="post">
            {{csrf_field()}}
            <div class="row">
                <label class="col-sm-4 col-lg-2 col-form-label">Name</label>
                <div class="col-sm-8 col-lg-10">
                    <div class="input-group">
                        <input type="text" class="form-control fill" required name="name" placeholder="Name">
                    </div>
                </div>
            </div>
