<div x-data="{ open: @entangle('open') }">
    ...
    <x-admin.off-canvas>
        <div>
            <h3 class="text-2xl font-semibold text-gray-900">{{ empty($condition) || !$condition->exists ? 'Add New Condition' : 'Edit Condition: ' . $condition->name }}</h3>
                            ...
                            >
                                ...
                                <tbody>
                                    @foreach ($conditions as $condition)
                                        <tr
                                            wire:click="setCondition({{ $condition->id }})"
                                        ...
                                        >
                                            ...
                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                                                {{ $condition->trashed() ? 'Deleted' : 'Active' }}
                                            </td>
