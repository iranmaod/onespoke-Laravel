<div x-data="{ open: @entangle('open') }">
    ...
    <x-admin.off-canvas>
        <div>
            <h3 class="text-2xl font-semibold text-gray-900">{{ empty($gender) || !$gender->exists ? 'Add New Gender' : 'Edit Gender: ' . $gender->name }}</h3>
                            ...
                            >
                                ...
                                <tbody>
                                    @foreach ($genders as $gender)
                                        <tr
                                            wire:click="setGender({{ $gender->id }})"
