<div x-data="{ open: @entangle('open') }">
    ...
    <x-admin.off-canvas>
        <div>
            <h3 class="text-2xl font-semibold text-gray-900">{{ empty($manufacturer) || !$manufacturer->exists ? 'Add New Manufacturer' : 'Edit Manufacturer: ' . $manufacturer->name }}</h3>
                            ...
                            >
                                ...
                                <tbody>
                                    @foreach ($manufacturers as $manufacturer)
                                        <tr
                                            wire:click="setManufacturer({{ $manufacturer->id }})"
                                        ...
                                        >
                                            ...
                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                                                {{ $manufacturer->trashed() ? 'Deleted' : 'Active' }}
                                            </td>
