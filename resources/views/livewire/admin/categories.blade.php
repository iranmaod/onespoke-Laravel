<div x-data="{ open: @entangle('open') }">
    ...
    <x-admin.off-canvas>
        <div>
            <h3 class="text-2xl font-semibold text-gray-900">{{ empty($category) || !$category->exists ? 'Add New Category' : 'Edit Category: ' . $category->name }}</h3>
                                ...
                                <tbody>
                                    @foreach ($categories as $category)
                                        ...
                                        >
                                            ...
                                            <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left">
                                                {{ $category->trashed() ? 'Deleted' : 'Active' }}
                                            </td>
