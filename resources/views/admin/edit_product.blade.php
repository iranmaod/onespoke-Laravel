            ...
            <div class="container mx-auto px-12">
                <div class="row">
                    <div class="grid pt-20 pb-20">
                        <h3 class="text-3xl font-bold text-center">EDIT <span class="orange"> PRODUCT </span></h3>
                    </div>
                    <div class="listing-form">
                        <form id="new-listing-form" class="w-full md:w-3/4 mx-auto" action="{{ route('product.update',$product->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-control flex flex-wrap -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="title" name="name" type="text" placeholder="The title of your listing" value="{{ $product->name ?? '' }}" required>
                                ...
                                <div class="w-full px-3">
                                    ...
                                    <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="supplier_id" name="supplier_id">
                                        ...
                                        @foreach (\App\Models\Supplier::all() as $manufacturer)
                                            <option value="{{ $manufacturer->id }}" {{ (!empty($product) && $product->manufacturer_id === $product->id) ? 'selected' : '' }}>{{ $manufacturer->name }}</option>
                                        @endforeach
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                <div class="form-control w-full px-3">
                                    ...
                                    <textarea rows="4" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="description" name="description" placeholder="More information about the bike (maximum 2,000 characters)" required>{{ $product->description ?? '' }}</textarea>
                                    <div class="error text-red-400"></div>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-12">
                                <div class="form-control w-full px-3 mb-3">
                                    ...
                                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="original_url" name="original_url" type="text" placeholder="original url" value="{{ $product->original_url }}">
                                    <div class="error text-red-400"></div>
                                </div>
                            ...
                            <div class="flex flex-wrap -mx-3 mb-6">
                                ...
                                <div class="form-control w-full md:w-1/2 px-3 mb-3">
                                    ...
                                    <div class="relative">
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="stock" name="stock" type="number" placeholder="Add Stock" value="{{ $product->stock ?? '' }}">
                                    </div>
                                    <div class="error text-red-400"></div>
                                </div>
                                <div class="form-control w-full md:w-1/2 px-3 mb-3">
                                    ...
                                    <div class="relative">
                                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="price" name="price" type="text" placeholder="" value="{{ empty($product) ? '' : $product->price }}">
                                    </div>
                                    <div class="error text-red-400"></div>
                                </div>
                            </div>
